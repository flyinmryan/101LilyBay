...
db.once("open", function(){
    ...
    todo.todoList.forEach(function (item) {
    	...
    	var listItem = mongoose.model("listItem", todoItem);
...
// app.route("/todoid").get(function(req, db){
// 	console.log(db);
	...
	// 	  // 	if (item != null){
	// 	  // 		str = str + "&nbsp&nbsp&nbsp&nbsptodo id&nbsp&nbsp" + item.Employeeid + "</br>";
	// 	  //  	}
	// 	  // })
	// 	  // res.send(str);
...
//   cursor.each(function(err, item){
//   	if (item != null){
//   		str = str + "&nbsp&nbsp&nbsp&nbspEmployee id&nbsp&nbsp" + item.Employeeid + "</br>";
//    	}
//   })
//   console.log("Database created!");
//   db.close();
